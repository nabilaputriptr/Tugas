    ...
    <table cellpadding="5" cellspacing="0" border="1">
        ...
        if (($query)==0) { //ini artinya jika data hasil query diatas kosong
            ...
            //jika data tidak kosong, maka akan melakukan perulangan while
             $no = "Tidak ada data!"; //membuat variabel $no untuk membuat nomor urut
            while ($data = ($query)) { //perulangan while dengan membuat variabel $data yang akan mengambil data di database 
            //menampilkan row dengan data di database
                ...
                href="hapus.php?sid='.$data['siswa_id'].'" onclick="return 
                confirm(\'Yakin?\')">Hapus</a></td>'; //menampilkan link edit dan hapus dimana tiap link terdapat GET id -> ?id ?id=siswa_id
                echo '</tr>';
